...
fun ReportsScreenContent(
    ...
    com.zamulabs.dineeasepos.components.ui.AppScaffold(
        modifier = modifier,
        topBar = { com.zamulabs.dineeasepos.components.ui.AppScreenTopBar(title = "Reports") },
        contentList = {
            ...
            item {
                Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.End){
                    com.zamulabs.dineeasepos.components.ui.AppButton(onClick = { onEvent(ReportsUiEvent.OnExport) }){ Text("Export Report") }
                }
            }
        }
    )
