...
$CertName = "CN=DineEase POS"
$FSName = "dineease-pos"
$PackageName = "DineeasePos"
$Site = "https://github.com/zamulabs/DineEasePOS/releases/latest/download"
...
start "shell:appsFolder\DineeasePos_1ndh55v8z6gca!DineeasePos"
